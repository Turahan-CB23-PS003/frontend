          ...
          <Stack
            ...
            <Box mb={{ base: 8, md: 20 }}>
              ...
              <Heading color={'white'} mb={5} fontSize={{ base: '3xl', md: '5xl' }}>
                Edukasi Tentang Pengelolaan Limbah Makananan dan Dampak Lingkungan
              </Heading>
              <Text fontSize={'xl'} color={'gray.400'}>
                Lorem ipsum dolor sit amet consectetur adipisicing elit. Incidunt, et iure fugit, culpa autem voluptates, commodi ad omnis iusto qui beatae alias vitae. Culpa, delectus? Repellat eius atque quis natus.
              </Text>
            </Box>
